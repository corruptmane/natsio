"""Shared fixtures for the natsio-counters test suite.
...
our pinned 2.14) and the connect/counter fixtures.
"""
...
# extensions/natsio-counters/tests/conftest.py -> repo root is parents[3].
